'use strict';
var observa = "";
app.reporteCC = kendo.observable({
    onShow: function () {
        try {
            llamarNuevoestilo("lydControlCalidad");
            llamarColorTexto(".w3-text-red");
            llamarNuevoestilo("confirmFirmaOTCCA");
            kendo.ui.progress($("#ordenesRelScreen"), false);
            var dataItemDoc = JSON.parse(localStorage.getItem("dataItemCC"));
            kendo.ui.progress($("#controlCalidadScreen"), false);
            localStorage.removeItem("griddataCC");
            $("#NoOrdenCC").text("Número de OT:  " + dataItemDoc.numero_orden);
            document.getElementById("tabstripCC").style.display = "none";
            document.getElementById("observacionCC").disabled = false;
            document.getElementById("firmaOTCCA").value = "";
            document.getElementById("btnFooterCC").innerHTML = "<button id='btnGuadaCC0' onclick='guardarCC();' class='w3-btn'><i id='icnGuadaCC0' class='fa fa-pencil' aria-hidden='true'></i> GUARDAR</button>" + "  " + "<button id='btnGuadaCC1' onclick='cabiaestadoCC();' class='w3-btn'><i id='icnGuadaCC1' class='fa-caret-square-o-down' aria-hidden='true'></i>CAMBIAR DE ESTADO</button>";
            llamarNuevoestilo("btnGuadaCC");
            llamarNuevoestiloIconB("icnGuadaCC");
            kendo.ui.progress($("#reporteCCScreen"), true);
            setTimeout(function () {
                var arrLi = ["liVideoRCC","liDatosRCC","liActividadesRCC", "liDetalleRCC","liFirmaASRCC"];
                var idLi = 1;
                ...
                datosotCC(dataItemDoc);
                infoDetalleOTCCMIO(dataItemDoc);
                actividadesOTCCMIO(dataItemDoc);
                // FIRMA DIGITAL ASESOR>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                document.getElementById('confirmFirmaOTCCA0').addEventListener('click', function () {
                    firmaDigitalOTCCAMIO();
                });
                document.getElementById('confirmFirmaOTCCA1').addEventListener('click', function () {
                    document.getElementById("firmaOTCCA").value = "";
                    document.getElementById("imgFirmaOTCCACC").innerHTML = "";
                });
                //>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><
                kendo.ui.progress($("#reporteCCScreen"), false);
            }, 2000);
        } catch (error) {
            kendo.ui.progress($("#reporteCCScreen"), false);
            alert("2" + error);
...
app.localization.registerView('reporteCC');

function actividadesOTCCMIO(dataItemCC) {
    var Url = localStorage.getItem("ls_url2").toLocaleString() + "/Services/ga/Garantias.svc/ga64RevisionGet/1," + localStorage.getItem("ls_idempresa").toLocaleString() + ";" + dataItemCC.tipo_mantenimiento + ";";
    ...
    document.getElementById("actividadesOTCC").innerHTML = "";
    try {
        ...
        document.getElementById("actividadesOTCC").innerHTML = htmlActividad + "</table>";
...
Parametros:
--------------------------------------------------------------------*/
function datosotCC(dataItemDoc) {
    document.getElementById("datosOTCC").innerHTML = "";
    try {
        //window.myalert("<center><i class=\"fa fa-exclamation-triangle\"></i> ALERTA</center>", dataItemDoc);
        var kilm = new Intl.NumberFormat("en-IN", {maximumSignificantDigits: 3}).format(dataItemDoc.kilometraje);

        document.getElementById("datosOTCC").innerHTML = "&nbsp;&nbsp;&nbsp;&nbsp;<table width='100%' cellpadding='0' cellspacing='0' border='0px'>" +
            "<tr style='border-bottom:1px solid'><td>" +
            "<br><label style='font-weight:bold; font-size:13px;color:black'>&nbsp;&nbsp;OT:&nbsp;&nbsp;</label>" +
            "</td><td>" +
            "<label style='font-weight:bold; font-size:13px;color:black'>&nbsp;&nbsp;" + dataItemDoc.numero_orden + "&nbsp;&nbsp;</label>" +
            "</td></tr>" +
            "<tr style='border-bottom:1px solid'><td>" +
            "<br><label style='font-weight:bold; font-size:13px;color:black'>&nbsp;&nbsp;NOMBRE DEL CLIENTE:&nbsp;&nbsp;</label>" +
            "</td><td>" +
            "<label style='font-weight:bold; font-size:13px;color:black'>&nbsp;&nbsp;" + dataItemDoc.nombre_cliente + "&nbsp;&nbsp;</label>" +
            "</td></tr>" +
            "<tr style='border-bottom:1px solid'><td>" +
            "<br><label style='font-weight:bold; font-size:13px;color:black'>&nbsp;&nbsp;TELEFONO:&nbsp;&nbsp;</label>" +
            "</td><td>" +
            "<label style='font-weight:bold; font-size:13px;color:black'>&nbsp;&nbsp;" + dataItemDoc.telefono_cliente + "&nbsp;&nbsp;</label>" +
            "</td></tr>" +
            "<tr style='border-bottom:1px solid'><td>" +
            "<br><label style='font-weight:bold; font-size:13px;color:black'>&nbsp;&nbsp;CELULAR:&nbsp;&nbsp;</label>" +
            "</td><td>" +
            "<label style='font-weight:bold; font-size:13px;color:black'>&nbsp;&nbsp;" + dataItemDoc.celular_cliente + "&nbsp;&nbsp;</label>" +
            "</td></tr>" +
            "<tr style='border-bottom:1px solid'><td>" +
            "<br><label style='font-weight:bold; font-size:13px;color:black'>&nbsp;&nbsp;FECHA RECEPCION:&nbsp;&nbsp;</label>" +
            "</td><td>" +
            "<label style='font-weight:bold; font-size:13px;color:black'>&nbsp;&nbsp;" + dataItemDoc.fecha_recepcion + "&nbsp;&nbsp;</label>" +
            "</td></tr>" +
            "<tr style='border-bottom:1px solid'><td>" +
            "<br><label style='font-weight:bold; font-size:13px;color:black'>&nbsp;&nbsp;VEHICULO:&nbsp;&nbsp;</label>" +
            "</td><td>" +
            "<label style='font-weight:bold; font-size:13px;color:black'>&nbsp;&nbsp;" + dataItemDoc.nombre_modelo + "&nbsp;&nbsp;</label>" +
            "</td></tr>" +
            "<tr style='border-bottom:1px solid'><td>" +
            "<br><label style='font-weight:bold; font-size:13px;color:black'>&nbsp;&nbsp;SECCION:&nbsp;&nbsp;</label>" +
            "</td><td>" +
            "<label style='font-weight:bold; font-size:13px;color:black'>&nbsp;&nbsp;" + dataItemDoc.seccion_orden_trabajo + "&nbsp;&nbsp;</label>" +
            "</td></tr>" +
            "<tr style='border-bottom:1px solid'><td>" +
            "<br><label style='font-weight:bold; font-size:13px;color:black'>&nbsp;&nbsp;TIPO DE TRABAJO:&nbsp;&nbsp;</label>" +
            "</td><td>" +
            "<label style='font-weight:bold; font-size:13px;color:black'>&nbsp;&nbsp;" + dataItemDoc.tipo_trabajo + " - " + dataItemDoc.nombre_tipo_trabajo + "&nbsp;&nbsp;</label>" +
            "</td></tr>" +
            "<tr style='border-bottom:1px solid'><td>" +
            "<br><label style='font-weight:bold; font-size:13px;color:black'>&nbsp;&nbsp;TIPO DE MANTENIMIENTO:&nbsp;&nbsp;</label>" +
            "</td><td>" +
            "<label style='font-weight:bold; font-size:13px;color:black'>&nbsp;&nbsp;" + dataItemDoc.tipo_mantenimiento + " - " + dataItemDoc.nombre_mantenimiento + "&nbsp;&nbsp;</label>" +
            "</td></tr>" +
            "<tr style='border-bottom:1px solid'><td>" +
            "<br><label style='font-weight:bold; font-size:13px;color:black'>&nbsp;&nbsp;KILOMETRAJE:&nbsp;&nbsp;</label>" +
            "</td><td>" +
            "<label pattern='[0-9]*' data-politespace data-grouplength='3' data-delimiter=',' data-reverse value='1234'  style='font-weight:bold; font-size:13px;color:black'>&nbsp;&nbsp;" + kilm + "&nbsp;&nbsp;</label>" +
            "</td></tr>" +
            "<tr style='border-bottom:1px solid'><td>" +
            "<br><label style='font-weight:bold; font-size:13px;color:black'>&nbsp;&nbsp;REPARACIONES SOLICITADAS:&nbsp;&nbsp;</label>" +
            "</td><td>" +
            "<label style='font-weight:bold; font-size:13px;color:black'>&nbsp;&nbsp;" + dataItemDoc.reparaciones_solicitadas + "&nbsp;&nbsp;</label>" +
            "</td></tr>" +
            "<tr style='border-bottom:1px solid'><td>" +
            "<br><label style='font-weight:bold; font-size:13px;color:black'>&nbsp;&nbsp;OBSERVACIONES:&nbsp;&nbsp;</label>" +
            "</td><td>" +
            "<label style='font-weight:bold; font-size:13px;color:black'>&nbsp;&nbsp;" + dataItemDoc.observaciones + "&nbsp;&nbsp;</label>" +
            "</td></tr></table>";
    } catch (error) {
        alert(error);
    }
...
--------------------------------------------------------------------*/
function infoDetalleOTCCMIO(dataItem) {
    try {
        /* kendo.ui.progress($("#reporteCCScreen"), true);
            setTimeout(function () { */
        // precarga ***********************

        var descri = (parseInt(localStorage.getItem("ls_dimensionW").toLocaleString()) * 20) / 100;
        var cant = (parseInt(localStorage.getItem("ls_dimensionW").toLocaleString()) * 20) / 100;
        var cla = (parseInt(localStorage.getItem("ls_dimensionW").toLocaleString()) * 10) / 100;
            ...
            success: function (data) {
                try {
                    if (inspeccionar(data).includes("DetalleOT") == true) {
                        infordetEVCCMIO = (JSON.parse(data.tl07DetalleOTGetResult)).DetalleOT;
                        if (inspeccionar(infordetEVCCMIO).length > 0) {
                            $("#detalleOTMIO").kendoGrid({
                                dataSource: {
                                    pageSize: 20,
                                    data: infordetEVCCMIO,
                                    aggregate: [
                                        {field: "descripcion", aggregate: "count", width: descri},
                                        //{ field: "clase_registro", title: "count", width: cant },
                                ...
                                columns: [
                                    ...
                                    {field: "clase_registro", title: "Clase Registro", width: 150},
                            ...
                            alert("3" + dataItem.numero_orden);

                            window.myalert("<center><i class=\"fa fa-exclamation-triangle\"></i>1 ALERTA</center>", "<center>No existe el detalle de la<br/>Orden de Trabajo <b>" + dataItem.numero_orden + "</b></center>");
                            //   kendo.mobile.application.navigate("components/admOt/view.html");
                        }

                    } else {
                        //alert("4"+dataItem.numero_orden);
...
function cabiaestadoCC() {
    kendo.ui.progress($("#reporteCCScreen"), true);
    setTimeout(function () {
        try {
            var validaCC = validaTablaCC();
            ...
            if (document.getElementById("titFirmaPregCCA").innerText.trim() == "Desea registrar la firma de control de calidad ?") {
                window.myalert("<center><i class=\"fa fa-exclamation-triangle\"></i> ALERTA</center>", "Debe Registrar Firma Control Calidad");
                return;
            }
            var msjPreguntaOT = "<center><h1><i class=\"fa fa-unlock\"></i> CONFIRMAR</h1><br />Ud. va a cambiar el estado del formulario, asegúrese <br /><b>De que haya GRABADO los últimos cambios</b></center>";
            kendo.confirm(msjPreguntaOT)
                .done(function () {
                    document.getElementById("titFirmaPregCCA").innerHTML = "<center><b>La firma del Auditor ya fue registrada<b></center>";
                    var dataRespuesta = JSON.parse(localStorage.getItem("griddataCC"));
                    var para = [];
                    para[0] = {
                        "modo": "3",
                        "codigo_empresa": dataRespuesta[0].codigo_empresa,
                        "codigo_sucursal": dataRespuesta[0].codigo_sucursal,
                        "codigo_taller": dataRespuesta[0].codigo_taller,
                        "anio_tl06": dataRespuesta[0].anio_tl06,
                        "secuencia_orden_tl06": dataRespuesta[0].secuencia_orden_tl06,
                        "secuencia_tl43": "",
                        "orden_presentacion": "FINALIZADO",
                        "pregunta": "",
                        "tipo_formulario": "",
                        "seccion_formulario": "",
                        "tipo_respuesta": "",
        ...
        for (var i = 0; i <= dataRespuesta.length - 1; i++) {
            if (dataRespuesta[i].tipo_respuesta == "SELECCION" || dataRespuesta[i].tipo_respuesta == "SEV") {
                ...
                if (dataRespuesta[i].tipo_objeto == "RADIO_BUTTON") {
                    ...
                    if (document.getElementById("SEL" + i).value.toLocaleString() !== "Seleccione") {
                        band = 1;
                    }
                }
...
function desactivaTablaCC(sn) {
    ...
    try {
        ...
        document.getElementById("observacionCC").disabled = sn;
        document.getElementById("btnGuadaCC1").disabled = sn;
        document.getElementById("btnGuadaCC0").disabled = sn;
    } catch (e) {
        alert("dis" + e);
    }
}
...
function firmaDigitalOTCC() {
    ...
    var htmlFirmaOTCC = "<table align='center' width='100%' style='border-bottom:1px solid'>" +
        "<tr>" +
        "<td>" +
        "<div id='idwrapOTCC' class='wrapper'><canvas id='signature-padCC' width='400' height='300'></canvas></div>" +
        "</td>" +
        "</tr>" +
        "</table>";

    dialogfirmaDigitalOTCC = $("#dialogfirmaDigitalOTCC").kendoDialog({
        width: "450px",
        buttonLayout: "normal",
        title: "INGRESE LA FIRMA",
        closable: false,
        modal: false,
        content: htmlFirmaOTCC,
        actions: [
            {
                text: '<font style=\"font-size:12px\"> <button id=\"save-jpeg0\" class=\"w3-btn\"> &nbsp;&nbsp;CONFIRMAR&nbsp;&nbsp;</button></font>',
                action: accFirmConfCC
            },
            {
                text: '<font style=\"font-size:12px\"><button id=\"save-jpeg1\" class=\"w3-btn\"> CANCELAR</button></font>',
                primary: true
            }
        ]
    });
...
function firmaDigitalOTCCAMIO() {
    ...
    var htmlFirmaOTAS = "<table align='center' width='100%' style='border-bottom:1px solid'>" +
        "<tr>" +
        "<td>" +
        "<div id='idwrapOTAS' class='wrapper'><canvas id='signature-padCCA' width='400' height='300'></canvas></div>" +
        "</td>" +
        "</tr>" +
        "</table>";
    dialogfirmaOTAS = $("#dialogfirmaOTCCA").kendoDialog({
        width: "450px",
        buttonLayout: "normal",
        title: "INGRESE LA FIRMA DEL ASESOR",
        closable: false,
        modal: false,
        content: htmlFirmaOTAS,
        actions: [
            {
                text: '<font style=\"font-size:12px\"> <button id=\"save-jpeg0\" class=\"w3-btn\"> &nbsp;&nbsp;CONFIRMAR&nbsp;&nbsp;</button></font>',
                action: accFirmConfASMIO
            },
            {
                text: '<font style=\"font-size:12px\"><button id=\"save-jpeg1\" class=\"w3-btn\"> CANCELAR</button></font>',
                primary: true
...
function accFirmConfASMIO() {
    ...
    document.getElementById("firmaOTCCA").value = "";
    document.getElementById("firmaOTCCA").innerHTML = "";
    document.getElementById("imgFirmaOTCCACC").innerHTML = "";
    ...
    document.getElementById("imgFirmaOTCCACC").innerHTML = "<img src='" + document.getElementById("firmaOTCCA").value + "' width='400' height='300'>";
}
...
Descripcion: Registra la firma en una imagen
--------------------------------------------------------------------*/
function accFirmConfCC() {
    if (signaturePad.isEmpty()) {
        window.myalert("<center><i class=\"fa fa-exclamation-triangle\"></i> ALERTA</center>", "<center>Ingrese la firma correspondiente</center>");
        return;
    }

    //document.getElementById("firmaOTCC").value = "";
    //document.getElementById("imgFirmaOTCC").innerHTML = "";

    var data = signaturePad.toDataURL('image/jpeg');
    //document.getElementById("firmaOTCC").value = data;
    ...
    /* document.getElementById("imgFirmaOTCC").innerHTML = "<img src='" + document.getElementById("firmaOTCC").value + "' width='400' height='300'>"; */
}

function imprime() {
    formatoImpConCal11(false);
    //cargadocCC(JSON.parse(localStorage.getItem("dataItem")));fa fa-print
}
        ...
        try {
            for (var i = 0; i < dataRespuesta.length; i++) {
                ...
                if (dataRespuesta[i].tipo_respuesta == "SELECCION" || dataRespuesta[i].tipo_respuesta == "SEV") {
                    ...
                    //dataRespuesta[i].selRespt = document.getElementById("SEL" + i).value.toLocaleString();
                    //alert("mios "+dataRespuesta[i].selRespt);
                }
                if (dataRespuesta[i].tipo_respuesta == "ER") {
                    for (var k = 0; k < dataRespuesta[i].erResp.length; k++) {
                        /* alert(dataRespuesta[i].selResp[m].sele + m);
                       alert(document.getElementById(dataRespuesta[i].selResp[m].sele + m).checked); */
                        if (document.getElementById("ER" + i + "" + k) != null) {
            ...
            if (dataRespuesta.length > 0) {
                try {
                    ...
                    for (var i = 0; i < dataRespuesta.length; i++) {
                        ...
                        para[i] = {
                            ...
                            "observacion_calidad": document.getElementById("observacionCC").value,
                            "observacion_calidad_cs": "",
                            "nombre_cliente_csi": "",
                            "telefono_fijo_csi": "",
                            "telefono_movil_csi": "",
                            "orden_relacionada": nmmotPRU
                        };
                ...
                var Url = localStorage.getItem("ls_url2").toLocaleString() + "/Services/TL/Taller.svc/tl43PreguntasCalidadSet";
                //var Url = "http://localhost:4044" + "/Services/TL/Taller.svc/tl43PreguntasCalidadSet";
                //var Url = "http://localhost:4044/Services/TL/Taller.svc/tg96CitasWebSet";
                //var Url = "http://200.31.10.92:8092/appk_aekia/Services/SL/Sherloc/Sherloc.svc/ClienteSet"
                /* var para = {
                   "modo": "6",
                   "codigo_empresa":"1",
                   "codigo_sucursal":"01",
                   "codigo_taller":"01",
                   "chasis":"8LCFT4111GE006737",
                   "codigo_marca":"KIA",
                   "codigo_modelo":"CERATO",
                   "anio_modelo":"2016",
                   "color_vehiculo":"PLATEADO",
                   "tipo_id_cliente":"CEDULA",
                   "identifica_cliente":"1706991294",
                   "nombre_cliente":"MORÑEJON,CEVÑALLOS,MIÑRYAN,CECÑILIA",
                   "direccion_cliente":"DOMICILIO",
                   "pais_cliente":"ECUADOR",
                   "ciudad_cliente":"QUITO",
                   "calle_cliente":"CALLE N51",
                   "numero_cliente":"SN",
                   "calle_interseccion":"GUAYACANES",
                   "celular_cliente":"0997636935",
                   "telefono_cliente":"022418217",
                   "email_cliente":"miryan_morejos@yahoo.com",
                   "Fecha_Cita":"2019-06-10",
                   "Hora_Cita":"12.45",
                   "Estado":"ACTIVO",
                   "Usuario_Creacion":"SEBAS",
                   "Fecha_Creacion":"2019-06-10",
                   "Usuario_Modificacion":"",
                   "Fecha_Modificacion":"",
                   "Requiere_Taxi":"YES",
                   "reparaciones_solicitadas":"MANTENIMIENTO 15000 CASI TODO BIEN",
                   "persona_nacionalidad":"ECUATORIANA",
                   "persona_tipo":"NATURAL",
                   "hora_creacion":"8.30",
                   "hora_modificacion":"",
                   "clave_af":"1",
                   "tipo_atencion":"RECEPCION"
                }; */
                //alert(Url);
                $.ajax({
                    url: Url,
                    ...
                    success: function (datas) {
                        ...
                        if (datas.substr(0, 1) == "1") {
                            //alert("se actualizaron los datos");
                            ConsultaControlCalidad(JSON.parse(localStorage.getItem("dataItemCC")));
                        } else {
                            alert(datas.substr(2, datas.length - 2));
                            return;
                        }
...
function ConsultaControlCalidad(inforusa) {
    try {
        //window.myalert("<center><i class=\"fa fa-exclamation-triangle\"></i> ERROR</center>", inspeccionar(inforusa));
        var tabstripCC1 = $("#tabstripCC").kendoTabStrip().data("kendoTabStrip");
        tabstripCC1.select(0);
        var respOT = "0";
        ...
        var infME;
        //document.getElementById("firmaGrafCC").value = "";
        //document.getElementById("imgFirmaOTCC").innerHTML = "";

        /* document.getElementById("confirmFirmaOTCC").style.display = 'initial';
        document.getElementById("cancelFirmaOTCC").style.display = 'initial'; */

        document.getElementById("firmaGrafCCA").value = "";
        document.getElementById("imgFirmaOTCCACC").innerHTML = "";

        document.getElementById("confirmFirmaOTCCA0").style.display = 'initial';
        document.getElementById("confirmFirmaOTCCA1").style.display = 'initial';
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                try {
                    ...
                    localStorage.setItem("inforImprime", JSON.stringify(infME));
                    respOT = "1";
                } catch (e) {
                    return;
                }
        ...
        if (respOT == "1") {
            try {
                ...
                for (var t = 0; t < infME.length; t++) {
                    ...
                    //window.myalert("<center><i class=\"fa fa-exclamation-triangle\"></i>0 ALERTA</center>", inspeccionar(infME[t]));
                }
            ...
            //localStorage.setItem("griddataCC", JSON.stringify(griddata));
            var tablaINP = cargatablaCC(griddata);
            //cargadocCC(griddata);
            document.getElementById("observacionCC").value = griddata[0].observacion_calidad;
            var registroME = "";

            generarOrdenPDFCCMIO(inforusa.numero_orden, "O");

            /* if (localStorage.getItem("numOTRELS").length > 0) {
                var otRELA = localStorage.getItem("numOTRELS").split(',');
                for (let index = 0; index < otRELA.length; index++) {
                    generarOrdenPDFCCMIO(otRELA[index], "O");
                }
            } */

            document.getElementById("tabstripCC").style.display = 'block';
            if (inforusa.estado_calidad !== "EN PROCESO" && inforusa.estado_calidad !== "") {
                desactivaTablaCC(true);
            }
            return tablaINP;
        }
        ...
        $.ajax({
            ...
            success: function (data) {
                try {
                    ...
                    window.myalert("<center><i class=\"fa fa-exclamation-triangle\"></i>360 ERROR</center>", inspeccionar(e));
                    respPar = "error";
                }
            },
            error: function (err) {
...
function cargatablaCC(griddata1) {
    try {
        //document.getElementById("pruebasfoc").focus();
        document.getElementById("descSMS_1RCC").innerHTML = "";
        dataRespuesta = "";
        var tablaOT = "";

        tablaOT = "<table BORDER CELLPADDING=10 CELLSPACING=10 id='docume' scr>";
        var cuerpo;
        tablaOT += "<tr align='center' style='background-color:#000000'><td></td><td><label style='font-weight:bold; font-size:13px;color:#ffffff'></label></td><td></td></tr>";
        for (var i = 0; i < griddata1.length - 1; i++) {
            var seccionFor = griddata1[i].seccion_formulario;
            tablaOT += "<tr style='background-color:#000000'><td align='center' style='width: 45%;'><label style='font-weight:bold; font-size:13px;color:#ffffff'>" + griddata1[i].nombre_seccion + "</label></td><td style='width: 2%;'></td><td style='width: 35%;'></td></tr>";
            while (griddata1[i].seccion_formulario == seccionFor) {
                ...
                //alert(griddata1[i].imagen+" - "+griddata1[i].tipo_respuesta);
                if (griddata1[i].tipo_respuesta == "SELECCION" || griddata1[i].tipo_respuesta == "SEV") {
                    ...
                    if (griddata1[i].tipo_respuesta == "SEV") {
                        ...
                        /* window.myalert("<center><i class=\"fa fa-exclamation-triangle\"></i> ERROR</center>", inspeccionar(valorsev)); placeholder=" + (l + 1) + "*/
                        //window.myalert("<center><i class=\"fa fa-exclamation-triangle\"></i> ERROR</center>", inspeccionar(valorsev));
                        var etiSEV = griddata1[i].lista_etiquetas.split(',');
                        for (var l = 0; l < griddata1[i].sevResp.length; l++) {
                            if (valorsev[l] === "undefined" || valorsev[l] === null) {
                                valorsev[l] = " ";
                            }

                            sevUsa += "<td><label>" + etiSEV[l] + "</label><p><input id=SEV" + i + "" + l + " type='" + tipoUsa + "' style='width:100%'  value='" + valorsev[l] + "'></p></td>";
                        }
                    ...
                    sevUsa += "</tr></table></td>";
                    //var selUsa = seleccionCC(griddata1[i].selResp, i, griddata1[i].selRespt);
                    //alert(griddata1[i].selRespt + "==" + griddata1[i].selResp);
                    if (griddata1[i].tipo_objeto == "RADIO_BUTTON") {
                        var selUsa = seleccionCCCHec(griddata1[i].selResp, i, griddata1[i].selRespt);
                    } else {
                        var selUsa = seleccionCC(griddata1[i].selResp, i, griddata1[i].selRespt);
                    }
                    ...
                    if (griddata1[i].tipo_respuesta == "ER") {
                        ...
                        var etiER = griddata1[i].lista_etiquetas.split(',');
                        for (var l = 0; l < griddata1[i].erResp.length; l++) {
                            if (valorer[l] === undefined || valorer[l] === null || valorer[l] === "") {
                                valorer[l] = " ";
                            }
                            sevUsa += "<td><p><label>" + etiER[l] + "</label><input id=ER" + i + "" + l + " type='text' size='2' value='" + valorer[l] + "'></p></td>";
                        }  //placeholder=" + griddata1[i].erResp[l].erR + "
                        ...
                        if (griddata1[i].tipo_respuesta == "EV") {
                            ...
                            var etiEV = griddata1[i].lista_etiquetas.split(',');
                            for (var l = 0; l < griddata1[i].evResp.length; l++) {
                                if (valorev[l] === "undefined" || valorev[l] === null) {
                                    valorev[l] = " ";
                                }
                                sevUsa += "<td><p><label>" + etiEV[l] + "</label><input id=EV" + i + "" + l + " type='" + tipoUsa + "' value='" + valorev[l] + "'></p></td>";
                            }
                            ...
                            sevUsa += "</tr></table></td>";
                            tablaOT += sevUsa + "<td></td>"; // placeholder=" + griddata1[i].evResp[l].evR + "
                        }
                    }
                }
                tablaOT += "</tr>";
        ...
        document.getElementById("descSMS_1RCC").innerHTML = " ";
        document.getElementById("descSMS_1RCC").innerHTML = tablaOT;
        document.getElementById("descSMS_1RCC").style.display = 'block';
        localStorage.setItem("griddataCC", JSON.stringify(griddata1));
...
function seleccionCCCHec(sele1, i, sele2) {
    try {
        var cboMarcaHTML = "";
        cboMarcaHTML += "<form name=fcolores>";

        for (var k = 0; k < sele1.length; k++) {
            //alert(sele2+ "==" +sele1[k].sele);
            if (sele2 == sele1[k].sele) {
                if (sele1[k].sele !== "Seleccione") {
                    cboMarcaHTML += "&nbsp;<input type='radio' id='" + sele1[k].sele + i + "' name='" + "SEL" + i + "' value='" + sele1[k].sele + "' checked><label for='" + sele1[k].sele + "'>&nbsp;" + sele1[k].sele + "</label>&nbsp;&nbsp;";
                }
            } else {
                if (sele1[k].sele !== "Seleccione") {
                    cboMarcaHTML += "&nbsp;<input type='radio' name='" + "SEL" + i + "' id='" + sele1[k].sele + i + "' value='" + sele1[k].sele + "'/>" +
...
function seleccionCC(sele1, i, sele2) {
    try {
...
function volverCC() {
    try {
        var dialogfirmaOTJT = $("#dialogfirmaOTJT").data("kendoDialog");
        dialogfirmaOTJT.close();
    } catch (e) {
    }
    banderaCC = 2;
...
function formatoImpConCal11(bolVisEV) {
    try {
        var inforImprime = JSON.parse(localStorage.getItem("dataItemCC"));
        var htmlFormatoEV = "";
        var repFirmaCC = "";

        var repFirmaCCA = "";
        if (document.getElementById("firmaGrafCCA").value.includes("_firmAS") == true && document.getElementById("firmaGrafCCA").value.includes("|") == true) {
            var arrImpFirmaCCA = document.getElementById("firmaGrafCCA").value.split("|");
            repFirmaCCA = "<img src='" + arrImpFirmaCCA[4] + "' height='80'>";
        ...
        var tablaDat = cargarTablaConC(JSON.parse(localStorage.getItem("dataItemCC")));
        ...
        htmlFormatoEV = "<table width='100%' cellpadding='2' cellspacing='0'>" +
            ...
            "<td>" +
            /* "<hr style='color:#C00000;border:2px solid' />" + */
            "</td>" +
            "</tr>" +
            "<tr>" +
            "<td>" +
            ...
            "      <td style='text-align:center;font-family:Arial; font-size:7px'><center>" + repFirmaCCA + "</center></td> " +
            "       <td style='text-align:center;font-family:Arial; font-size:7px'>&nbsp;</td>" +
            "       <td style='text-align:center;font-family:Arial; font-size:7px'>&nbsp;</td>" +
            "       <td style='text-align:center;font-family:Arial; font-size:7px'><center>" + repFirmaCC + "</center></td>" +
            "       <td style='text-align:center;font-family:Arial; font-size:7px'>&nbsp;</td>" +
            "    </tr>" +
            "    <tr>" +
            "     <td style='text-align:center;font-family:Arial; font-size:7px'>&nbsp;</td>" +
            ...
            "    <tr>" +
            "     <td style='text-align:center;font-family:Arial; font-size:7px'>&nbsp;</td>" +
            "     <td style='text-align:center;font-family:Arial; font-size:7px'>Firma Control Calidad</td>" +
            "     <td style='text-align:center;font-family:Arial; font-size:7px'>&nbsp;</td>" +
            "     <td style='text-align:center;font-family:Arial; font-size:7px'>&nbsp;</td>" +
...
"               <table style='width:100%' cellspacing='0' cellpadding='0'>" +
        ...
        "</tr>"+
           ...
           "</tr>" +
           "</table>";
           //localStorage.setItem("htmlImprime", htmlFormatoEV);
           //window.myalert("<center><i class=\"fa fa-exclamation-triangle\"></i> IMPRIME</center>", htmlFormatoEV);
...
/* function cargarTablaConC(inforImprime) {
    try {

        var html_ev_01 = "<br><table cellpadding='0' cellspacing='0' border='0'>" +
                          "<tr style='border-bottom:1pt solid black;'><td width='20%'><p><label style='font-family:Arial; font-size:11px; font-color: black'>Orden de reparación: <font color='blue'>"+ inforImprime.numero_orden+"</font></p></td><td></td><td width='20%'><p><label style='font-family:Arial; font-size:11px; font-color: black'>Nombre del cliente: <font color='blue'>" + inforImprime.nombre_propietario + "</font></p></td></tr>"+
                          "<tr style='border-bottom:1pt solid black;'><td width='20%'><p><label style='font-family:Arial; font-size:11px; font-color: black'>Vehículo: <font color='blue'>"+inforImprime.nombre_modelo+"</font></p></td><td></td><td width='20%'><p><label style='font-family:Arial; font-size:11px; font-color: black'>Teléfono: <font color='blue'>"+inforImprime.telefono_cliente+"</font></p></td></tr>" +
                          "<tr style='border-bottom:1pt solid black;'><td width='20%'><p><label style='font-family:Arial; font-size:11px; font-color: black'>Chasis: <font color='blue'>"+inforImprime.chasis+"</font></p></td><td width='20%'><p><label style='font-family:Arial; font-size:11px'></td><td width='20%'><p><label style='font-family:Arial; font-size:11px; font-color: black'>Celular: <font color='blue'>"+inforImprime.celular_cliente+"</font></p></td></tr>" +
                          "<tr style='border-bottom:1pt solid black;'><td width='20%'><p><label style='font-family:Arial; font-size:11px; font-color: black'>Kilometraje: <font color='blue'>"+inforImprime.kilometraje+"</font></p></td><td></td><td width='20%'><p><label style='font-family:Arial; font-size:11px; font-color: black'>Fecha: <font color='blue'>"+inforImprime.fecha_cita+"</font></p></td></tr></table>";
    } catch (e) {
        alert("1"+e);
    }
    return html_ev_01;
...
/* function cargatabla_1AVA(griddata1) {
    ...
    for (var i = 0; i < griddata1.length; i++) {
        var seccionFor = griddata1[i].seccion_formulario;
        //  alert(seccionFor);
        tablaOT += "<tr style='background-color:black'><td style='width: 80%;'><p><label style='font-weight:bold; font-size:11px;color:white' >" +
            ...
            if (griddata1[i].tipo_respuesta == "SELECCION" || griddata1[i].tipo_respuesta == "SEV") {
                ...
                if (griddata1[i].tipo_respuesta == "SEV") {
                    ...
                    for (var l = 0; l < griddata1[i].sevResp.length; l++) {
                        ...
                        sevUsa += "<td>&nbsp;</td>";
                        //sevUsa += "<td><p><input id=SEV" + i + "" + l + " type='" + tipoUsa + "' style='width:100%' placeholder=" + (l + 1) + " value=" + valorsev[l] + "></p></td>";placeholder=" + (l + 1) + "
                        sevUsa += "<td><p><input id=SEV" + i + "" + l + "style='width:100%' value=" + valorsev[l] + "></p></td>";
                    }
                }
                sevUsa += "</tr></table></td>";
                ...
                var selUsa = griddata1[i].selRespt;
                ...
                if (griddata1[i].tipo_respuesta == "ER") {
                    ...
                    for (var l = 0; l < griddata1[i].erResp.length; l++) {
                        sevUsa += "<td>&nbsp;</td>";
                        sevUsa += "<td><p><input id=ER" + i + "" + l + " type='text' size='2' value=" + valorer[l] + "></p></td>";
                    }
                    sevUsa += "</tr></table></td>";
                    if (griddata1[i].selRespt.length == 0) {
                        bolImprimeEV = false;
                    }
                    var selUsa = griddata1[i].selRespt;  //seleccionUSA(griddata1[i].selResp, i, griddata1[i].selRespt);placeholder=" + griddata1[i].evResp[l].evR + "
                    tablaOT += sevUsa + "<td><p><label style='font-family:Arial; font-size:11px'>" + selUsa + "</label></p></td>";
                } else {
                    if (griddata1[i].tipo_respuesta == "EV") {
                        var sevUsa = "<td><table style='width: 100%;'><tr>";
                        ...
                        for (var l = 0; l < griddata1[i].evResp.length; l++) {
                            sevUsa += "<td>&nbsp;</td>";
                            sevUsa += "<td><p><input id=EV" + i + "" + l + " type='text' size='2' value=" + valorev[l] + "></p></td>";
                        }
                        sevUsa += "</tr></table></td>";
...
function generarOrdenPDFCCMIO(strArchivo, tipoPDF) {
    try {
        localStorage.removeItem("htmlImprime");
        //document.getElementById("firmaGrafCC").value = "";
        document.getElementById("firmaGrafCCA").value = "";

        //document.getElementById("titFirmaPregCC").innerHTML = "Desea registrar la firma del cliente ?<br />";
        document.getElementById("titFirmaPregCCA").innerHTML = "Desea registrar la firma de control de calidad ?<br />";
        /* formatoImpConCalCC2();

        var htmlOrden = localStorage.getElementById("htmlImprime"); */
        var htmlOrden = "";
        var camposEV = parametrosEntregaCompletoOTCCMIO();
        ...
        if (tipoPDF == "O") {
            ...
            // firma base64
            //strFirma = document.getElementById("firmaOTCC").value;
            strFirmaAS = document.getElementById("firmaOTCCA").value;
        } else {
            htmlOrden = ""; //formatoImpConCalCC2();
            htmlOrden = localStorage.getElementById("htmlImprime").toLocaleString();
            //alert(htmlOrden);
        ...
        var params = {
            ...
            "strFirma": "",
            "strFirmaAS": strFirmaAS,
            "strFirmaJT": ""
        };
        //window.myalert("<center><i class=\"fa fa-exclamation-triangle\"></i>formatoRep02_mail</center>", inspeccionar(params));
        ...
        $.ajax({
            ...
            success: function (data) {
                try {
                    ...
                    var respMail = JSON.stringify(data[0]);
                    ...
                    if (respMail.includes("Succes")) {
                        ...
                        document.getElementById("firmaGrafCCA").value = data2;


                        if (document.getElementById("firmaGrafCCA").value.includes("CC_firmAS.") == true) {
                            document.getElementById("titFirmaPregCCA").innerHTML = "<center><b>La firma de control de calidad ya fue registrada<b></center>";
                            document.getElementById("confirmFirmaOTCCA0").style.display = 'none';
                            document.getElementById("confirmFirmaOTCCA1").style.display = 'none';
                        }
...
function parametrosEntregaCompletoOTCCMIO() {
    try {
        ...
        $.ajax({
            ...
            success: function (data) {
                try {
                    ...
                    window.myalert("<center><i class=\"fa fa-exclamation-triangle\"></i>361 ERROR</center>", inspeccionar(e));
                    respPar = "error";
                }
            },
            error: function (err) {
